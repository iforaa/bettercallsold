<script lang="ts">
	...
	// Load and render the products page
	async function loadProducts() {
		...
		try {
			...
			// Render the products page using the active products template
...
<svelte:head>
	<title>Products - {storeSettings?.store_name || 'My Store'}</title>
	<meta name="description" content="Browse all products at {storeSettings?.store_name || 'our store'}" />
</svelte:head>
...
{:else if storeContent}
	<!-- Render the complete products page with live Liquid content -->
...
{:else}
	<div class="empty-store">
		<div class="empty-content">
			<h1>Products Not Ready</h1>
			<p>No products template found. Please create a products template in the website builder.</p>
