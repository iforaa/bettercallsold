<script lang="ts">
	...
	// Load and render the collections page
	async function loadCollections() {
		...
		try {
			...
			// Render the collections page using the active collections template
...
<svelte:head>
	<title>Collections - {storeSettings?.store_name || 'My Store'}</title>
	<meta name="description" content="Browse our collections at {storeSettings?.store_name || 'our store'}" />
</svelte:head>
...
{:else if storeContent}
	<!-- Render the complete collections page with live Liquid content -->
...
{:else}
	<div class="empty-store">
		<div class="empty-content">
			<h1>Collections Not Ready</h1>
			<p>No collections template found. Please create a collections template in the website builder.</p>
